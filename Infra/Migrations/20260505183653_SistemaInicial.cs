    ...
    public partial class SistemaInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pequisa", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pequisa_Empresa_IdEmpresa",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pergunta_Pequisa_IdPesquisa",
                        column: x => x.IdPesquisa,
                        principalTable: "Pequisa",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ativo = table.Column<bool>(type: "bit", nullable: false),
                    Order1 = table.Column<int>(name: "Order = 1", type: "int", nullable: false),
                    Nome = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
