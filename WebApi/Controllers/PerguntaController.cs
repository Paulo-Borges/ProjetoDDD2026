...
namespace WebApi.Controllers
{
    ...
    public class PerguntaController : ControllerBase
    {
        ...
        [HttpGet("/api/GetPerguntaById")]              // Os Metódos
        ...
        [HttpGet("/api/GetAllPerguntas")]              // Os Metódos
        [Produces("aplication/json")]
        ...
        [HttpGet("/api/ObterPerguntaComOpcoes/{idPergunta}")]                // Metódo Customizados
        [Produces("aplication/json")]
        ...
        [HttpPost("/api/AdicionarPesquisaOpcoes")]                // Metódo Customizados
        [Produces("aplication/json")]
        ...
        [HttpPost("/api/AtualizarPesquisaOpcoes")]                // Metódo Customizados
        [Produces("aplication/json")]
        ...
        [HttpPost("/api/UpdatePergunta")]                // Metódo 
        [Produces("aplication/json")]
        ...
        [HttpDelete("/api/DeletePergunta")]                // Metódo 
        [Produces("aplication/json")]
